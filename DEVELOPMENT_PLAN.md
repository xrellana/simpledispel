...
- [x] CHANGELOG。
- [x] 版本号和 TOC metadata。
- [x] 生成并验证 Party/Raid beta ZIP 安装结构。
...
先用 `0.10.0-beta.3` 在地下城复测安全按钮和 Aura 图标点击；通过后再完成一次团队实测，验证 5+40 固定单位按钮、当前目标保持、战斗锁定、40 容器性能以及 `/reload` 持久化。通过前不进入自动提醒或更多团队布局选项。
